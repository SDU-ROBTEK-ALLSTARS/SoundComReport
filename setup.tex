...
\hypersetup{
    ...
    pdftitle={A generic protocol stack},    % title
    ...
    pdfsubject={DTMF as information carrier},   % subject of the document
    pdfkeywords={DTMF} {network} {protocol} {SDU}, % list of keywords
