\section{Data link layer}% Overview and considerations
...
This leads to the following format\marginnote{We must either refer to tables by latex label (preferred?) or place them as non-float} of a frame:
