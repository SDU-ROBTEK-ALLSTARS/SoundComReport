...
\end{itemize}
	...
	\begin{lstlisting}[float=!h,language={C++},caption={PortAudios callback function declaration. This declaration is used for both input
...
static int paStreamCallback(const void *inputBuffer,
	...
	due to time constraints, but a rule of thumb is, be sure to fire the input callback at least twice as often as the output callback.
		...
		\begin{lstlisting}[float=!h,language={C++},caption={Implementation of \smalltt{paOutputStreamCallback}},label={lst:pa_stream_callback}]
