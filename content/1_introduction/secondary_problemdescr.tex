...
\item Git\footnote{The repository, containing full history of the commits to the project, can be cloned from \url{ https://github.com/SDU-ROBTEK-3SEM-E11-G1/SoundComCode.git}} and GitHub\footnote{\url{https://github.com/}} is used as version control system for the report and the software.
\end{itemize}
