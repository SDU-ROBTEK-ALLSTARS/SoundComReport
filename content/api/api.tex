...
This method is used when sending data. It returns an empty message, and enables the user to fill in the message data manually. A reference is kept in the \custtt{DtmfApi}, so the message can sent itself by the build-in send method. This reference is also used to cleanup unused messages.
