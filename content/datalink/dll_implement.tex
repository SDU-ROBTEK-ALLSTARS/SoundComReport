...
The data link layer is implemented as a \custtt{DataLinkLayer} class and a Frame class.
...
can call a method (\custtt{needs\-Attention}) to know whether the data link layer need
